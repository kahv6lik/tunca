// Türkiye il ve ilçe listesi (plaka sırasıyla). Firma formunda İl seçilince
// ilgili ilçeler otomatik gelir.
...
export const IL_ILCE: Record<string, string[]> = {
  ...
  Amasya: ["Göynücek", "Gümüşhacıköy", "Hamamözü", "Merzifon", "Merkez", "Suluova", "Taşova"],
...
// İl adları — Türkçe alfabetik sıralı
export const ILLER = Object.keys(IL_ILCE).sort((a, b) =>
  a.localeCompare(b, "tr")
);

export function ilceler(il: string): string[] {
  return (IL_ILCE[il] ?? []).slice().sort((a, b) => a.localeCompare(b, "tr"));
}
