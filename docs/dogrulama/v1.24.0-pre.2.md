# Doğrulama Raporu — v1.24.0-pre.2
...
| ✅ Cevap veren sunucu bu çalıştırmaya ait | pid=5448 |
...
3. Doğrudan URL ile çapraz kiracı erişimi
  ✅ A, B'nin firma verisini göremiyor — "Star Yazılım A.Ş. 1"
