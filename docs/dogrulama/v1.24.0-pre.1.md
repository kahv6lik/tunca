# Doğrulama Raporu — v1.24.0-pre.1
...
| ✅ Migration'lar temiz veritabanına uygulandı | 19 migration |
| ✅ İki kiracılı demo veri üretildi | 11 adım |
| ✅ Otomatik testler (Vitest) | 532/532 kontrol |
| ✅ Port 3100 boş | eski sunucu kalıntısı yok |
| ✅ Sunucu ayağa kalktı | http://localhost:3100 |
| ✅ Cevap veren sunucu bu çalıştırmaya ait | pid=24136 |
| ✅ Kiracı izolasyonu — HTTP | 14/14 kontrol |
| ✅ Kimlik doğrulama — gerçek tarayıcı | 268/268 kontrol |
...
3. Doğrudan URL ile çapraz kiracı erişimi
  ✅ A, B'nin firma verisini göremiyor — "Star Elektronik A.Ş. 1"
